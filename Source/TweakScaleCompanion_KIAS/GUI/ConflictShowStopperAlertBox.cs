...
namespace TweakScaleCompanion.KIAS.GUI
{
	...
	{
		private const string URL = "https://ksp.lisias.net/add-ons/TweakScaleCompanion/Support/KIAS/conflict-detected";
		private static readonly string MSG = @"Unfortunately TweakScale Companion KIAS is unable to safely proceed due conflicting issues!

You have {0} installed, and this is known to prevent this Companion from working correctly, leading KSP to inject bad information on your savegames' KIAS parts with TweakScale.
